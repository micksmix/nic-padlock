...
type
  ...
  public
    constructor Create(CreateSuspended: Boolean; ExecuteEvent: TThreadExecuteEvent;
      AFreeOnTerminate: Boolean; iThrd: integer);
  end;
...
constructor TSimpleThread.Create(CreateSuspended: Boolean;
  ExecuteEvent: TThreadExecuteEvent; AFreeOnTerminate: Boolean; iThrd: integer);
begin
  FreeOnTerminate := AFreeOnTerminate;
  FExecuteEvent := ExecuteEvent;
  NameThreadForDebugging('ThreadPool_Thread_' + IntToStr(iThrd));
...
begin
  ...
  begin
    FThreads.Add(TSimpleThread.Create(False, DoHandleThreadExecute, False, iCurThrd));
    InterlockedIncrement(iCurThrd);
  end;
end;
