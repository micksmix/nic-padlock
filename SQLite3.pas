...
function SQLite3_Open(filename: PAnsiChar; var db: TSQLiteDB): integer; cdecl; external SQLiteDLL name
  'sqlite3_open';
function SQLite3_Open16(filename: PChar; var db: TSQLiteDB): integer; cdecl; external SQLiteDLL name
  'sqlite3_open16';
function SQLite3_Close(db: TSQLiteDB): integer; cdecl; external SQLiteDLL name 'sqlite3_close';
function SQLite3_Exec(db: TSQLiteDB; SQLStatement: PAnsiChar; CallbackPtr: TSQLiteExecCallback; UserData:
  Pointer; var ErrMsg: PChar): integer; cdecl; external SQLiteDLL name 'sqlite3_exec';
...
function SQLite3_GetTable(db: TSQLiteDB; SQLStatement: PAnsiChar; var ResultPtr: TSQLiteResult; var RowCount:
  Cardinal; var ColCount: Cardinal; var ErrMsg: PChar): integer; cdecl; external SQLiteDLL name
  'sqlite3_get_table';
...
procedure SQLite3_BusyHandler(db: TSQLiteDB; CallbackPtr: TSQLiteBusyHandlerCallback; UserData: Pointer);
  cdecl; external SQLiteDLL name 'sqlite3_busy_handler';
...
function SQLite3_Prepare(db: TSQLiteDB; SQLStatement: PAnsiChar; nBytes: integer; var hStmt: TSqliteStmt; var
  pzTail: PChar): integer; cdecl; external SQLiteDLL name 'sqlite3_prepare';
function SQLite3_Prepare_v2(db: TSQLiteDB; SQLStatement: PAnsiChar; nBytes: integer; var hStmt: TSqliteStmt;
  var pzTail: PChar): integer; cdecl; external SQLiteDLL name 'sqlite3_prepare_v2';
function SQLite3_Prepare16(db: TSQLiteDB; SQLStatement: PChar; nBytes: integer; var hStmt: TSqliteStmt; var
  pzTail: PChar): integer; cdecl; external SQLiteDLL name 'sqlite3_prepare16';
function SQLite3_Prepare16_v2(db: TSQLiteDB; SQLStatement: PChar; nBytes: integer; var hStmt: TSqliteStmt; var
  pzTail: PChar): integer; cdecl; external SQLiteDLL name 'sqlite3_prepare16_v2';
function SQLite3_ColumnCount(hStmt: TSqliteStmt): integer; cdecl; external SQLiteDLL name
  'sqlite3_column_count';
function SQLite3_ColumnName(hStmt: TSqliteStmt; ColNum: integer): PAnsiChar; cdecl; external SQLiteDLL name
  'sqlite3_column_name';
function SQLite3_ColumnName16(hStmt: TSqliteStmt; ColNum: integer): PChar; cdecl; external SQLiteDLL name
  'sqlite3_column_name16';
function SQLite3_ColumnDeclType(hStmt: TSqliteStmt; ColNum: integer): PAnsiChar; cdecl; external SQLiteDLL
  name 'sqlite3_column_decltype';
function SQLite3_ColumnDeclType16(hStmt: TSqliteStmt; ColNum: integer): PChar; cdecl; external SQLiteDLL name
...
function SQLite3_ColumnBlob(hStmt: TSqliteStmt; ColNum: integer): pointer; cdecl; external SQLiteDLL name
  'sqlite3_column_blob';
function SQLite3_ColumnBytes(hStmt: TSqliteStmt; ColNum: integer): integer; cdecl; external SQLiteDLL name
  'sqlite3_column_bytes';
function SQLite3_ColumnBytes16(hStmt: TSqliteStmt; ColNum: integer): integer; cdecl; external SQLiteDLL name
  'sqlite3_column_bytes16';
function SQLite3_ColumnDouble(hStmt: TSqliteStmt; ColNum: integer): double; cdecl; external SQLiteDLL name
  'sqlite3_column_double';
function SQLite3_ColumnInt(hStmt: TSqliteStmt; ColNum: integer): integer; cdecl; external SQLiteDLL name
  'sqlite3_column_int';
function SQLite3_ColumnText(hStmt: TSqliteStmt; ColNum: integer): PAnsiChar; cdecl; external SQLiteDLL name
  'sqlite3_column_text';
function SQLite3_ColumnText16(hStmt: TSqliteStmt; ColNum: integer): PChar; cdecl; external SQLiteDLL name
  'sqlite3_column_text16';
function SQLite3_ColumnType(hStmt: TSqliteStmt; ColNum: integer): integer; cdecl; external SQLiteDLL name
  'sqlite3_column_type';
function SQLite3_ColumnInt64(hStmt: TSqliteStmt; ColNum: integer): Int64; cdecl; external SQLiteDLL name
...
function SQLite3_Backup_Init(DestDb: TSQLiteDB; DestDbName: PAnsiChar; SourceDb: TSQLiteDB; SourceDbName:
  PAnsiChar): TSqliteBackup; cdecl; external SQLiteDLL name 'sqlite3_backup_init';
function SQLite3_Backup_Step(hBackup: TSQLiteBackup; nPage: integer): integer; cdecl; external SQLiteDLL name
  'sqlite3_backup_step';
function SQLite3_Backup_Finish(hBackup: TSQLiteBackup): integer; cdecl; external SQLiteDLL name
  'sqlite3_backup_finish';
function SQLite3_Backup_Remaining(hBackup: TSQLiteBackup): integer; cdecl; external SQLiteDLL name
  'sqlite3_backup_remaining';
function SQLite3_Backup_Pagecount(hBackup: TSQLiteBackup): integer; cdecl; external SQLiteDLL name
